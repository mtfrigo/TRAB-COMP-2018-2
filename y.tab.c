...
static const char *const yytname[] =
{
  ...
  "OPERATOR_ATTRIB", "';'", "'+'", "'-'", "'='", "'*'", "'('", "')'",
  "$accept", "program", "cmdlist", "cmd", "expr", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     275,   276,   277,   278,   279,   280,   281,    59,    43,    45,
      61,    42,    40,    41
};
# endif
...
{
      -3,   -18,   -15,     8,   -25,    -3,   -11,   -25,   -18,    -6,
     -18,   -25,   -25,   -18,   -24,   -18,   -18,   -18,   -18,   -25,
       5,    -2,   -25,     9,     9,     9,     9,   -25,   -25
};
...
{
       1,     6,     7,     1,    15,    16,    17,    18,    11,    22,
      14,    10,    20,     2,     8,    21,     2,    23,    24,    25,
      26,    13,    15,    16,    17,    18,    15,    16,    17,    18,
      12,    28,    27,    15,    16,    17,    18,    15,    16,    17,
      18,    19
};

static const yytype_uint8 yycheck[] =
{
       6,    19,    20,     6,    28,    29,    30,    31,     0,    33,
       8,    26,    10,    19,    32,    13,    19,    15,    16,    17,
      18,    32,    28,    29,    30,    31,    28,    29,    30,    31,
       5,    33,    27,    28,    29,    30,    31,    28,    29,    30,
      31,     9
};
...
{
       0,     6,    19,    35,    36,    37,    19,    20,    32,    38,
      26,     0,    36,    32,    38,    28,    29,    30,    31,    37,
      38,    38,    33,    38,    38,    38,    38,    27,    33
};
